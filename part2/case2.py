...
def max_over_all_actions(itr,pos,mat,arr,sta,hea):
        ...
        if pos == 0:
            ...
            if sta == 0:
                ...
                if act == 3:
                    ...
                    value = (0 + gamma*(1.0*(0.2*utility[itr-1,0,mat,arr,1,hea] + 0.8*utility[itr-1,0,mat,arr,0,hea])))
            ...
            # ready state (sta=1)
                ...
                if act == 3:
                    ...
                    value = (0 + gamma*(1.0*(0.5*utility[itr-1,0,mat,arr,1,hea] + 0.5*utility[itr-1,0,mat,arr,0,hea])))
        ...
        # north square (IJ will not be affected by MM's attack here) 
            ...
            if sta == 0:
                ...
                if act == 1:
                    ...
                    value = (0 + gamma*(0.85*(0.2*utility[itr-1,pos,mat,arr,1,hea] + 0.8*utility[itr-1,pos,mat,arr,0,hea]) + 0.15*(0.2*utility[itr-1,2,mat,arr,1,hea] + 0.8*utility[itr-1,2,mat,arr,0,hea])))
            ...
            # ready state (sta=1)
                ...
                if act == 1:
                    ...
                    value = (0 + gamma*(0.85*(0.5*utility[itr-1,pos,mat,arr,1,hea] + 0.5*utility[itr-1,pos,mat,arr,0,hea]) + 0.15*(0.5*utility[itr-1,2,mat,arr,1,hea] + 0.5*utility[itr-1,2,mat,arr,0,hea])))
        ...
        # east square (IJ will be affected by MM's attack now) 
            ...
            if sta == 0:
                ...
                if act == 2:
                    ...
                    value = (0 + gamma*(1.0*(0.2*utility[itr-1,pos,mat,arr,1,hea] + 0.8*utility[itr-1,pos,mat,arr,0,hea])))
            ...
            # ready state (sta=1)  
                ...
                if act == 2:
                    ...
                    value = (0 -0.5*bad_reward  + gamma*(1.0*(0.5*utility[itr-1,pos,mat,0,0,min(100,hea+25)] + 0.5*utility[itr-1,pos,mat,arr,1,hea])))
        ...
        # Center square (IJ will not be affected by MM's attack here)
            ...
            # ready state (sta=1) 
                ...
                if act == 0:
                    ...
                    value = (0 -0.5*bad_reward + gamma*(0.85*(0.5*utility[itr-1,pos,mat,0,0,min(100,hea+25)] + 0.5*utility[itr-1,pos,mat,arr,1,hea]) + 0.15*(0.5*utility[itr-1,pos,mat,0,0,min(100,hea+25)] + 0.5*utility[itr-1,2,mat,arr,1,hea])))
    ...
    f = open("part_2_task_2.2_trace.txt", "a")
